  ...
  if(user && result){
    return (
      <main className="mb-24">
        ...
        <div className="max-w-3xl mx-auto mb-12 mt-6 p-8 lg:p-12 bg-base-200 rounded-3xl flex flex-col lg:flex-row gap-8 lg:gap-12 lg:justify-between">
          <div className="space-y-6">
            <p className="text-xl font-semibold text-primary">🍜 Ramen Profitable</p>
            <p className="text-base-content-secondary">
              Take your indie hacking journey to the next level!
            </p>
          ...
          <div className="bg-base-300 rounded-2xl lg:rounded-3xl p-8 lg:p-12 text-center space-y-6 -mx-4 -mb-4 lg:-m-8">
            <p className="text-base-content-secondary font-semibold">
              <span className="">Pay once</span>, get{" "}
              <span className="underline decoration-accent underline-offset-2 decoration-2">
                lifetime access
              </span>
            </p>
            <div className="flex items-baseline justify-center gap-x-2">
              <span className="text-xl tracking-tight text-base-content-secondary line-through decoration-[1.5px]">
                $49
              </span>
              <div className="text-5xl font-bold tracking-tight">$29</div>
              <span className="text-sm font-semibold leading-6 tracking-wide text-base-content-secondary">
                USD
              </span>
            </div>
            <div>
              <button className="btn btn-primary btn-block gap-2 lg:btn-wide ">
                Unlock forever
              </button>
              <p className="text-sm text-base-content-secondary mt-2">
                🔥 41% OFF for beta testers
              </p>
            </div>
          </div>
        </div>
